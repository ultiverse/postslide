      ...
      <div className="flex items-center justify-between cursor-default">
        ...
        {hasOverrides && (
          <button
            ...
            className="flex items-center gap-1 rounded px-2 py-0.5 text-xs font-medium text-brand-600 transition-colors hover:bg-brand-100 active:bg-brand-200 cursor-pointer"
        ...
        <div className="flex gap-1">
          {(['left', 'center', 'right'] as const).map((align) => (
            <button
              ...
              className={`flex-1 rounded border px-3 py-1.5 text-xs font-medium transition-all ${(style.textAlign || 'left') === align
